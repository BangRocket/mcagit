...
- Or use `dotnet run --project src/McaGit -c Release --no-build -- <args>` after building.
...
- Built CLI (assembly renamed mcadiff→mcagit 2026-06-06): `src/McaGit/bin/Release/net10.0/mcagit.dll`.
- CRITICAL zsh gotcha: a multi-word var like `MCAGIT="/usr/.../dotnet /path/mcagit.dll"`
  ...
  function instead:
  ```sh
  mcagit() { /usr/local/share/dotnet/dotnet /Volumes/Storage/Code/minecraft/mca-git/src/McaGit/bin/Release/net10.0/mcagit.dll "$@"; }
  ```
...
## CLI Pattern
```powershell
$cli = "C:\Users\steven.cady\repos\personal\mcagit\src\McaGit"
