...
- **File**: `src/McaDiff/Repo/Checkout.cs`, `PruneStray()`
...
- **File**: `src/McaDiff/Repo/Packfile.cs`, `Write()`, lines 173-175
...
- **File**: `src/McaDiff/Repo/ObjectStore.cs` (`StoredSize`), `src/McaDiff/Repo/Gc.cs` (`Repack`)
...
- **File**: `src/McaDiff/Repo/Delta.cs`, `Apply()`, line 71
...
- **File**: `src/McaDiff/Repo/Checkout.cs`, `Materialize()`, line 13
...
- **File**: `src/McaDiff/Repo/IgnoreRules.cs`, `Rule.Matches()`, line 74
...
- **File**: `src/McaDiff/Repo/ObjectStore.cs`
...
- **File**: `src/McaDiff/Repo/Checkout.cs:28`, `src/McaDiff/Anvil/RegionWriter.cs:58-60`
...
- **File**: `src/McaDiff/Repo/ChunkCache.cs`, `Save()`
...
- **File**: `src/McaDiff/Repo/ChunkCache.cs`
