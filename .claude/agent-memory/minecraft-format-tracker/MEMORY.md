...
- [Project state: mcagit Anvil/NBT code gaps](project-state.md) — LZ4 throws UnsupportedChunkException, .mcc file has no header (raw payload), poi NbtIdentity gap, dimensions/ not scanned, block_states opaque
